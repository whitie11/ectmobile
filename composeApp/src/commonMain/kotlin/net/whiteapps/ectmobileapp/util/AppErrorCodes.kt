 ...
 */
enum class AppErrorCodes(val message: String) {
    ...
    UNKNOWN_NHS("This service user is not in database."),
    ...
    INVALID_PASSWORD(message= "Password not recognised"),
    NETWORK_ERROR(message= "Network error. Check your internet connection."),
    TIMED_OUT(message = "Took too long")
